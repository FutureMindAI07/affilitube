                    ...
                    <TableBody>
                      {paginatedChannels.map((channel) => (
                        ...
                        >
                          ...
                          <TableCell>
                            <div className="flex flex-wrap gap-1" data-testid={`affiliate-platforms-cell-${channel.channel_id}`}>
                              {(() => {
                                    ...
                                    <>
                                      ...
                                      {hiddenCount > 0 && (
                                        <span
                                          ...
                                          title={hiddenLabels}
                                          data-testid={`affiliate-platforms-more-${channel.channel_id}`}
                                        >
                                          +{hiddenCount}
                                        </span>
                                      )}
                                ...
                                // Fallback: links detected but no named platform matched
                                if ((channel.affiliate_links_total || 0) > 0) {
                                  return (
                                    <span
                                      ...
                                      data-testid={`affiliate-links-fallback-${channel.channel_id}`}
                                    >
                                      <Link className="h-2.5 w-2.5" />
